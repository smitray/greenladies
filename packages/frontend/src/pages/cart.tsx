										...
										>
											<div style={{ textAlign: 'right' }}>
												<select
													...
													value={item.amount}
												>
													{Array.from({ length: Math.min(item.product.quantity, 10) }, (_, i) => i + 1).map(amount => (
											...
											<div>
												<div style={{ display: 'flex', marginBottom: '4px' }}>
													<div style={{ textDecoration: 'line-through', whiteSpace: 'nowrap' }}>
														{(item.product.originalPrice * item.amount).toFixed(2).replace('.', ',')} kr
													</div>
													<div style={{ color: 'red', marginLeft: '16px', whiteSpace: 'nowrap' }}>
